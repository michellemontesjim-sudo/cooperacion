...
public class ControladorTiempo : PlayerAlquimia
{
    ...
    protected override void ExecuteAbilityLogic()
    {
        if (heldItem != null)
        {
            ...
            Debug.Log("�Ingrediente transformado con �xito por el Poder del Tiempo!");
        }
        else
        {
            Debug.LogWarning("El minijuego se complet�, pero 'heldItem' sigue siendo nulo para el script del jugador.");
        }
    }
}
